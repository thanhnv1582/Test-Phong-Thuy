...
export const TamThangDetailsScreen: FC<
  StackScreenProps<NavigatorParamList, "ttdetails">
> = observer(({ route, navigation }) => {
  ...
  const _renderBookmarkItems = ({ item }) => <Item value={item.value} title={item.title} />
  return (
    <>
